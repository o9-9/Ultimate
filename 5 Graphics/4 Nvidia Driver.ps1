...
# download 7zip
Get-FileFromWeb -URL "https://github.com/o9-9/files/raw/main/7 Zip.exe" -File "$env:TEMP\7 Zip.exe"
# install 7zip
...
Get-FileFromWeb -URL "https://github.com/o9-9/files/raw/main/NV%20Clean%20Install.exe" -File "$env:TEMP\NV Clean Install.exe"
